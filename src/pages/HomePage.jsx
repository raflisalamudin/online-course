        ...
        <Container>
          <Row className="header-box d-flex align-items-center pt-lg-5">
            <Col lg="6">
              ...
              <p className="mb-4 animate__animated animate__fadeInUp animate__delay-1s">Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit vero voluptates dolores recusandae distinctio labore.</p>
              ...
              <button className="btn btn-outline-danger btn-lg rounded-1 animate__animated animate__fadeInUp animate__delay-1s">Lihat Promo</button>
            </Col>
